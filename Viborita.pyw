...
#Esta es la funcion madre de todo el proceso
def main():
    global serpiente, comida
    ventana = pygame.display.set_mode((400, 400)) #Tamanio de la ventana en pixeles
    ventana.fill((0, 0, 0)) #Color que se le da al fondo (los 3 ceros indican negro)
